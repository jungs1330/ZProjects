...
namespace ZDataStructure
{
    ...
    public class ZPriorityQueue<TPriority, TValue> : ICollection<KeyValuePair<TPriority, TValue>>
    {
        ...
        public ZPriorityQueue(int capacity)
        ...
        public ZPriorityQueue(int capacity, IComparer<TPriority> comparer)
        {
            if (comparer == null)
        ...
        /// </summary>
        /// <param name="comparer">priority comparer</param>
        public ZPriorityQueue(IComparer<TPriority> comparer)
        {
            if (comparer == null)
                throw new ArgumentNullException();
        ...
        public ZPriorityQueue(IEnumerable<KeyValuePair<TPriority, TValue>> data)
        ...
        /// <param name="data">data to be inserted into priority queue</param>
        /// <param name="comparer">priority comparer</param>
        public ZPriorityQueue(IEnumerable<KeyValuePair<TPriority, TValue>> data, IComparer<TPriority> comparer)
        {
        ...
        /// </remarks>
        public static ZPriorityQueue<TPriority, TValue> MergeQueues(ZPriorityQueue<TPriority, TValue> pq1, ZPriorityQueue<TPriority, TValue> pq2)
        {
        ...
        /// <returns>resultant priority queue</returns>
        public static ZPriorityQueue<TPriority, TValue> MergeQueues(ZPriorityQueue<TPriority, TValue> pq1, ZPriorityQueue<TPriority, TValue> pq2, IComparer<TPriority> comparer)
        {
            if (pq1 == null || pq2 == null || comparer == null)
                throw new ArgumentNullException();
            // merge data
            ZPriorityQueue<TPriority, TValue> result = new ZPriorityQueue<TPriority, TValue>(pq1.Count + pq2.Count, pq1._comparer);
